      ...
      <div className='bg-light p-5 rounded' style={{width:'500px'}}>
        ...
        <form className='mt-5' onSubmit={handleCalculate}>
          ...
          <Stack direction="row" spacing={2}>
            <Button type='submit' style={{height:'70px',width:'250px'}} className='bg-dark mt-3' variant="contained" disabled={validPrinciple && validRate && validYear ? false : true}> Calculate </Button>
